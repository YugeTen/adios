...
class SimCLR_ADIOS(BaseADIOSModel):
    def __init__(
        self,
        output_dim: int,
        proj_hidden_dim: int,
        ...
        **kwargs
        ...
        pass, the masking function generates N masks from an input image, all of which are
        then applied to the image N times.
    ...
    def add_model_specific_args(parent_parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        parent_parser = super(SimCLR_ADIOS, SimCLR_ADIOS).add_model_specific_args(parent_parser)
    ...
    def flip_inpainter_grad(self, status: bool):
